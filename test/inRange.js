...
assert.equals(
  TEST_NAME,
  "Returns false if a too small value is out of range",
  "_.inRange(0, 1, 3)",
  _.inRange(0, 1, 3),
  false
);
assert.equals(
  TEST_NAME,
  "Returns false if a too large value is out of range",
  "_.inRange(4, 1, 3)",
  _.inRange(4, 1, 3),
  false
);
...
assert.equals(
  TEST_NAME,
  "Returns true if provided value is same as start value",
  "_.inRange(1, 1, 3)",
  _.inRange(1, 1, 3),
  true
);
assert.equals(
  TEST_NAME,
  "Returns false if provided value is same as end value",
  "_.inRange(3, 1, 3)",
  _.inRange(3, 1, 3),
  false
);
